		...
		<div class="container">
			...
			<div class="row">
				<div class="col-sm-6 offset-sm-3">
					<div class="post-block">
						<div class="d-flex justify-content-between">
							<div class="d-flex mb-3">
								<div class="mr-2">
									<a href="#!" class="text-dark"><img src="img/user1.jpg" alt="User" class="author-img" width = "40"></a>
								</div>
								<div>
									<h5 class="mb-0"><a href="#!" class="text-dark"><?php
						echo $blog_title;
					?></a></h5>
					...
					echo $blog_text;
				?></p>
							<img src="<?php echo $image?>" alt="Content img" width = "550">
						</div>
						<div class="mb-3">
						...
						<div class="post-block__comments">
							...
							<div class="comment-view-box mb-3">
								<div class="d-flex mb-2">
									<img src="img/user2.jpg" alt="User img" class="author-img author-img--small mr-2" width = "40" height = "43">
									<div>
